...
class SutherlandHogmanPolygonClipping extends JPanel {
	...
	SutherlandHogmanPolygonClipping(double xmin, double ymin, double xmax,
	                                double ymax, int edges, int[] poly,
	                                boolean clipped) {
		this.xmin = xmin;
		this.ymin = ymin;
		this.xmax = xmax;
	...
	public static void main(String[] args) {
		...
		double xmin = 100, ymin = 100, xmax = 200, ymax = 200; // Bounds of Clipping Rectangle

		// Coordinates  of edges of the polygon
		poly[0] = 80; poly[1] = 125; poly[2] = 150;
		poly[3] = 150; poly[4] = 80; poly[5] = 180;
