...
class ThreeDTransform extends JPanel {
	...
	double[][] scale(int a, int b, int c) {
		double[][] _edges = edges;
	...
	double[][] translate(int a, int b, int c) {
		double[][] _edges = edges;
	...
	double[][] rotate(int ch, double theta) {
	...
	public static void main(String[] args) {
		...
		double[][] initialEdges = panel.edges.clone(); // Store the initial figure
		...
		while (true) {
			...
			b = scanner.nextInt();
			c = scanner.nextInt();
			double[][] translatedEdges = panel.translate(a, b, c);
			panel.edges = translatedEdges;
			panel.repaint();
			waitForEnter();
			...
			b = scanner.nextInt();
			c = scanner.nextInt();
			double[][] scaledEdges = panel.scale(a, b, c);
			panel.edges = scaledEdges;
			panel.repaint();
			waitForEnter();
			...
			double[][] rotatedEdges = panel.rotate(ch, theta);
			panel.edges = rotatedEdges;
			panel.repaint();
			waitForEnter();
			...
			ch = scanner.nextInt();
			double[][] reflectedEdges = panel.reflect(ch);
			panel.edges = reflectedEdges;
			panel.repaint();
			waitForEnter();
