...
# creates a new table with columns id and name
goods_name <- data.frame(id, name)

# This line updates the labels of items in the transaction data with their corresponding names from the goods_name data frame.
